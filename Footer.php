...
?>
	...
	<div class="col-sm-4 text-justify">
      ...
      <p style="color:white;"><strong>Address:&nbsp;</strong>Ave 7, Kigali, Rwanda</p>
      <p style="color:white;"><strong>Email-Id:&nbsp;</strong>hotel@gmail.com</p>
      <p style="color:white;"><strong>Contact Us:&nbsp;</strong>(+255) 755 461 333</p><br><br><br>
     <center><img src="image/devlop/wen2.jpg"class="img-responsive"style="width:200px;height:200px;border-radius:100%;"></center>
	</div>&nbsp;
